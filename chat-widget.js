...
<head>
  ...
  <style>
    ...
    #chat-form input, #chat-form textarea {
      width: 100%;
      max-width: 260px; /* Fixes the stretching */
      padding: 8px;
      margin: 8px auto; /* Centers the fields */
...
<div id="chat-form-container">
  ...
  <div id="text-bubble">
    Enter your info below and any information regarding your vehicle choice and a SuperCars Ltd representative will be right with you.
  </div>
  ...
  <div id="confirmation-bubble">
    Thanks for your enquiry. One of our authorized SuperCars Ltd representatives will be in touch any minute now. 🏎️
  </div>
